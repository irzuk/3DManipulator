...
// source: https://github.com/arduino/Arduino/blob/43b0818f7fa8073301db1b80ac832b7b7596b828/arduino-core/src/processing/app/Serial.java
import jssc.*;
...
import static Visualisation.I18n.format;
import static Visualisation.I18n.tr;
...
//    }
    ...
    public static boolean touchForCDCReset(String iname) throws SerialException {
        ...
        try {
            ...
            throw new SerialException("Error touching serial port ''{0}''.");
        } finally {
    ...
    public Serial(String iname, int irate, char iparity, int idatabits, float istopbits, boolean setRTS, boolean setDTR) throws SerialException {
        ...
        try {
           ...
           // }
            ...
            //throw new SerialException("Error opening serial port ''{0}''.");
        }
    }
    ...
    public void setPipe(PipedWriter pipedWriter) {
    ...
    public synchronized void serialEvent(SerialPortEvent serialEvent) {
        if (serialEvent.isRXCHAR()) {
            try {
                ...
                String buf = port.readString(serialEvent.getEventValue());
                ...
                while (stack.contains(",")) {
                    ...
                    int x = 0;
                    try {
                        x = Integer.parseInt(stack.substring(0,index));
                        //System.out.println(stack.substring(0,index));
    ...
    public void processSerialEvent(String str) {
